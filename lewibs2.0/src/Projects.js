...
function Projects() {
    return (
        <section id='projects'>
            ...
            <Project image='../images/wackamon.PNG' title='Wakamon' info='I made this game to practice using a finite state machine in which each wackamon hole does an action based on the state that it is in. This was written i vanilla javascript with the exception of ajax for keeping track of user scores.' website='http://wackamon.lewibs.com/' source='https://github.com/lewibs/wack_a_mon' />
